...
parser.add_argument('--peft', default=None, type=str, choices=('lora', 'prune', 'prune-grads', 'sequential-adapter', 'parallel-adapter'), help='the peft method to use, either lora, prune or prune-grads')
...
parser.add_argument('--bottleneck_ratio', default=4, type=float, help='The ratio to decrease the features width in adapter peft')